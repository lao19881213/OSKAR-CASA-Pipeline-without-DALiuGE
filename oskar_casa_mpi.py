...
if __name__ == '__main__':
    ...
    os.system('python /BIGDATA/ac_shao_tan_1/OSKAR/OSKAR_CASA/no_daliuge/create_settings.py /BIGDATA/ac_shao_tan_1/OSKAR/OSKAR_CASA/no_daliuge/config/1_%s /BIGDATA/ac_shao_tan_1/OSKAR/OSKAR_CASA/no_daliuge/gleam_mod.20k.mod' % rank_str)
